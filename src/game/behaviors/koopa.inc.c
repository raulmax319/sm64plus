...
static void koopa_the_quick_act_show_init_text(void) {
    ...
    if ((configStayInCourse == 2) && (gCurrCourseNum == COURSE_BOB))
    {
...
static void koopa_the_quick_act_after_race(void) {
    ...
    if (o->parentObj->oKoopaRaceEndpointDialog == 0) {
        ...
        if (dialogResponse != 0) {
            ...
            if ((configStayInCourse == 2) && (gCurrCourseNum == COURSE_BOB) && (o->parentObj->oKoopaRaceEndpointRaceStatus == 0))
            {
                // JUMP
                o->oVelY = 140.0f;
                o->oGravity = -6.0f;
    ...
    if ((configStayInCourse == 2) && (gCurrCourseNum == COURSE_BOB) && (o->oPosY > 5500))
    {
