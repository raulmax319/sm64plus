...
static const struct ConfigOption options[] = {
    ...
    { .name = "make_certain_items_respawn", .type = CONFIG_TYPE_BOOL, .boolValue = &configRespawnCertainItems },
    ...
    { .name = "add_a_quit_option", .type = CONFIG_TYPE_BOOL, .boolValue = &configQuitOption },
