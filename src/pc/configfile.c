...
static const struct ConfigOption options[] = {
    ...
    { .name = "save_lives", .type = CONFIG_TYPE_BOOL, .boolValue = &configSaveLives },
    ...
    { .name = "better_powerups", .type = CONFIG_TYPE_BOOL, .boolValue = &configBetterPowerups },
    { .name = "better_enemies", .type = CONFIG_TYPE_BOOL, .boolValue = &configBetterEnemies },
    { .name = "better_blast_away_the_wall", .type = CONFIG_TYPE_BOOL, .boolValue = &configBetterBlastAwayTheWall },
    { .name = "better_npcs", .type = CONFIG_TYPE_BOOL, .boolValue = &configTalkNPCs },
