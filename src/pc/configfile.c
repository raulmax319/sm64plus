...
static const struct ConfigOption options[] = {
    ...
    { .name = "improved_swimming", .type = CONFIG_TYPE_BOOL, .boolValue = &gImprovedSwimming },
    ...
    { .name = "better_blast_away_the_wall", .type = CONFIG_TYPE_BOOL, .boolValue = &gBetterBlastAwayTheWall },
    ...
    { .name = "stay_in_course_after_getting_a_star", .type = CONFIG_TYPE_UINT, .uintValue = &gStayInLevel },
    { .name = "skip_mission_select", .type = CONFIG_TYPE_BOOL, .boolValue = &gSkipStarSelect },
    { .name = "auto_switch_to_the_next_mission", .type = CONFIG_TYPE_BOOL, .boolValue = &gRestartLevelAfterStar },
    ...
    { .name = "auto_rotate_custom_camera", .type = CONFIG_TYPE_BOOL, .boolValue = &configCustomCameraRotate },
    ...
    { .name = "exit_mission_select_with_b", .type = CONFIG_TYPE_BOOL, .boolValue = &configExitMissionSelectWithB },
    { .name = "hud_layout", .type = CONFIG_TYPE_UINT, .uintValue = &gHudStyle },
    ...
    { .name = "spin_jump", .type = CONFIG_TYPE_BOOL, .boolValue = &configSpinJump },
