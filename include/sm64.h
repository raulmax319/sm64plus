...
#define ACT_ROLL                       0x0080845B // (0x05B | ACT_FLAG_MOVING | ACT_FLAG_SHORT_HITBOX | ACT_FLAG_ATTACKING)
...
#define ACT_ROLL_FALL                  0x0100088B // (0x08B | ACT_FLAG_AIR | ACT_FLAG_ALLOW_VERTICAL_WIND_ACTION)
